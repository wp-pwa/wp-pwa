...
- Fix wrong service worker path

#### 1.6.12

- Refactor service workers

#### 1.6.11

- Always cache HTML files again
...
- Add aditional files to SW from WP

#### 1.6.7

- Don't cache bootstrap and remove slash from urls
